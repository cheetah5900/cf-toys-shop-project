    ...
    <div class="container">
        <div class="row divspace">
            <table style="width:100%">
                ...
                <td class="content borderbuttom" style="font-size:30px;padding-left:20px">กดปุ่ม <img style="width:70px;" src="assets/img/chat-button.png"> ที่มุมขวาล่างจอแล้ว ทักแอดมินได้เลยค้าบ</td>
                </tr>  
            </table> 
        </div> <!-- row -->
    </div><!--container -->
